...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_topics_url = QtWidgets.QLabel(parent=self.groupBox_server_info)
        self.label_topics_url.setObjectName("label_topics_url")
        self.gridLayout_3.addWidget(self.label_topics_url, 1, 0, 1, 1)
        self.line_topics_url = QtWidgets.QLineEdit(parent=self.groupBox_server_info)
        self.line_topics_url.setObjectName("line_topics_url")
        self.gridLayout_3.addWidget(self.line_topics_url, 1, 1, 1, 1)
        self.pb_change_topics_url = QtWidgets.QPushButton(parent=self.groupBox_server_info)
        self.pb_change_topics_url.setMaximumSize(QtCore.QSize(30, 16777215))
        self.pb_change_topics_url.setObjectName("pb_change_topics_url")
        self.gridLayout_3.addWidget(self.pb_change_topics_url, 1, 2, 1, 1)
        ...
        Dialog.setTabOrder(self.cb_tray_icon_unread, self.groupBox_sound)
        Dialog.setTabOrder(self.groupBox_sound, self.line_sound)
        Dialog.setTabOrder(self.line_sound, self.pb_sound)
        Dialog.setTabOrder(self.pb_sound, self.cb_priority_colors)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_sound.setTitle(_translate("Dialog", "Play a notification sound"))
        self.pb_sound.setToolTip(_translate("Dialog", "Choose notification sound file"))
        self.pb_sound.setText(_translate("Dialog", "..."))
        self.groupBox_2.setTitle(_translate("Dialog", "Interface"))
        self.label_3.setText(_translate("Dialog", "Application style:"))
...
"8..10 -> high"))
        ...
        self.label_topics_url.setText(_translate("Dialog", "Topics JSON URL:"))
        self.pb_change_topics_url.setToolTip(_translate("Dialog", "Apply topics URL"))
        self.pb_change_topics_url.setText(_translate("Dialog", "..."))
