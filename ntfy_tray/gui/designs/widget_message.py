# Form implementation generated from reading ui file 'ntfy_tray/gui/designs\widget_message.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_frame.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetDefaultConstraint)
        self.gridLayout_frame.setContentsMargins(0, 0, -1, 0)
        self.gridLayout_frame.setVerticalSpacing(0)
        ...
        self.gridLayout_frame.addWidget(self.label_message, 2, 3, 1, 4)
        ...
        self.gridLayout_frame.addWidget(self.label_priority, 0, 1, 4, 1)
        spacerItem2 = QtWidgets.QSpacerItem(0, 6, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.gridLayout_frame.addItem(spacerItem2, 3, 3, 1, 4)
