# Form implementation generated from reading ui file 'ntfy_tray/gui/designs/widget_server.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.pb_test, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_import, 1, 5, 1, 1)
        ...
        self.gridLayout.addLayout(self.formLayout, 0, 1, 1, 6)
        ...
        self.pb_certificate = QtWidgets.QPushButton(parent=Dialog)
        self.pb_certificate.setObjectName("pb_certificate")
        self.gridLayout.addWidget(self.pb_certificate, 1, 4, 1, 1)
        self.label_status = QtWidgets.QLabel(parent=Dialog)
        self.label_status.setText("")
        self.label_status.setObjectName("label_status")
        self.gridLayout.addWidget(self.label_status, 3, 1, 1, 6)
